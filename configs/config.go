...
// 存储所有配置项的类型[阿里云OSS，本地图片路径，图床类型，百度OCR，百度翻译，翻译类型，腾讯翻译，阿里翻译]
var ConfigTypes = [...]string{"alioss", "limgpath",
	"imgbed", "bdocr", "bdtrans", "trans", "txtrans", "alitrans", 
	"mdconf", "sysconf"}
...
var AliTrans = [...]string{"mtAccessKeyId", "mtAccessKeySecret", "region", "type", "from", "to", "method", "scene"}
var Trans = [...]string{"transType"} // 翻译类型配置项
var MdConf = [...]string{"theme"} // markdown 文档配置项
var SysConf = [...]string{"theme"} // 系统配置项
